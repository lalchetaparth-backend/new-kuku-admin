...
export const navSections = [
  {
    items: [
      ...
      {
        path: "/distributors",
        labelLines: ["Distributor", "Inquiries"],
  ...
  },
  {
    ...
    items: [
      ...
      {
        path: "/customers",
        labelLines: ["Customers"],
        countKey: "customers_count",
        symbol: "people",
        showDot: true,
      },
      {
        path: "/corporate-gifts",
        labelLines: ["Coporate Gift", "Inquiries"],
        iconClass: "bi bi-gift",
        showDot: true,
      },
      {
        path: "/inquiries",
        labelLines: ["Inquiries"],
        symbol: "puzzle",
        showDot: true,
      },
    ],
